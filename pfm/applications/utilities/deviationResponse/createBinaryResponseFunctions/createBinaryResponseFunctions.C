...
Application
    createBinaryResponseFunctions

Description
    Reads all response functions of a time series stored in ASCII format and
...
int main(int argc, char *argv[])
{
 ...
 // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
    ...
    forAll(dataBases,i)
    {
        ...
        Info << "Conversion of response functions of database " << dbName <<" done\n" << endl;
    }
