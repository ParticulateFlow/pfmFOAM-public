...
Foam::ADMcontinuousModels::regularizationModels::Stolz::Stolz
(
...
Foam::ADMcontinuousModels::regularizationModels::Stolz::regTerm
(
     const volScalarField& alpha,
...
bool Foam::ADMcontinuousModels::regularizationModels::
Stolz::read()
{
